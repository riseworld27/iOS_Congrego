...
+ (UIColor *) colorWithKelvin:(CGFloat)kelvin
{
    if ((kelvin < 1000) || (kelvin > 40000))
        CLS_LOG(@"Warning: temperature should range between 1000 and 40000");
...
+ (NSDictionary *) colorDictionaryNamed: (NSString *) dictionaryName
{
    ...
    if (!dictionaryName)
    {
        CLS_LOG(@"Error: invalid dictionary name");
        return nil;
    }
...
+ (UIColor *) colorWithName: (NSString *) name inDictionary: (NSString *) dictionaryName
{
    ...
    {
        CLS_LOG(@"Error: invalid color or dictionary name");
        return nil;
    }
...
+ (UIColor *) colorWithName: (NSString *) name
{
    ...
    if (!name)
    {
        CLS_LOG(@"Error: invalid color name");
        return nil;
    }
...
- (NSString *) closestColorNameUsingDictionary: (NSString *) dictionaryName
{
    ...
    if (!dictionaryName)
    {
        CLS_LOG(@"Error: Must suply dictionary name to look up color");
        return nil;
    }
